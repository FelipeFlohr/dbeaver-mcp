...
(
    ...
    random_string    VARCHAR2(128)                                  NOT NULL,
    random_date      date                                           NOT NULL,
    random_date_time TIMESTAMP                                      NOT NULL,
    random_boolean   NUMBER(1),
...
VALUES ('xK9mPqL2vNwR7tYs', DATE '2024-03-15', TIMESTAMP '2024-03-15 14:30:45', 1);

INSERT INTO parent_test_entity (random_string, random_date, random_date_time, random_boolean)
VALUES ('bH4jFcA8eZuW1oMn', DATE '2024-07-22', TIMESTAMP '2024-07-22 09:15:30', 0);
