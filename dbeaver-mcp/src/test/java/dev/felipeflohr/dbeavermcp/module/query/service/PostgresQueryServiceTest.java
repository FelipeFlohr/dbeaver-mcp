...
class PostgresQueryServiceTest extends BaseQueryServiceTest {
    ...
    void testCannotInsertInReadOnlyTransaction() throws SQLException, DBeaverMCPValidationException, InterruptedException {
        ...
        """;
        List<StatementResponseDTO> responses = postgresQueryService.executeReadOnlyStatements(List.of(sql), TestcontainersConfiguration.POSTGRES_CONNECTION_NAME, null);
        ...
        assertTrue(error.getMessage().contains("cannot execute INSERT in a read-only transaction"));
    }
    ...
    void testTimeoutIsEnforced() throws DBeaverMCPValidationException {
        ...
        List<StatementResponseDTO> responses = postgresQueryService.executeReadOnlyStatements(List.of(sql), TestcontainersConfiguration.POSTGRES_CONNECTION_NAME, 1);
